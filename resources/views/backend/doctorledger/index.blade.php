                     ...
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{$today_earning}}</a>
                           </h3>
               ...
               <div class="kt-portlet kt-iconbox kt-iconbox--wave">
                  <div class="kt-portlet__body">
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{$earnings_this_month}}</a>
                           </h3>
                           <div class="kt-iconbox__content">
                              Earning This Month
                           </div>
               ...
               <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                  <div class="kt-portlet__body">
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{$earnings_this_year}}</a>
                           </h3>
                           <div class="kt-iconbox__content">
                              Earning This Year
                           </div>
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  <thead>
                     <tr>
                        ...
                        <th title="Field #2">Amount Payable</th>
                        <th title="Field #4">Amount Paid</th>
                        <th title="Field #4">Cashback</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>{{$q->payable_amount != null ? $q->payable_amount : "NILL"}}</td>
                        <td>{{$q->paid_amount != null ? $q->paid_amount : "NILL"}}</td>
                        <td>{{$q->cashback != null ? $q->cashback : "0.0"}}</td>
                        <td>{{date('d M Y',strtotime($q->created_at))}}</td>
                        <td>
                           <span style="display: inline;">
                           <a href="/account/appointment/invoice/{{$q->appointment->invoice->id}}" class="btn btn-danger btn-sm">Invoice</a>
                           <a href="/account/appointment/settings/{{$q->appointment->id}}" class="btn btn-success btn-sm">Details</a>
                           </span>
                        </td>
                     </tr>
                     @endforeach
