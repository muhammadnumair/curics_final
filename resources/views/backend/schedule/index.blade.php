               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/schedule/create" class="btn btn-brand btn-elevate btn-icon-sm">
                     ...
                     <tr>
                        ...
                        <td>
                           <span style="display: inline;">
                              <a href="/account/schedule/edit/{{$s->id}}" class="btn btn-success btn-sm">Edit</a>
                              <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/schedule', ['id' => $s->id]) }}" style="display: inline;" method="post">
