   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/language/update/{{$language->id}}" method="post">
               @csrf
               <div class="kt-portlet__body">
                  <div class="form-group">
                     <label>Language Name</label>
                     <input class="form-control @error('language_name') is-invalid @enderror" value="{{ old('language_name', $language->language_name) }}" type="text" id="language_name" name="language_name">
                     @error('language_name')
                  ...
                  <div class="form-group row">
							...
							<div class="col-11">
								<span class="kt-switch kt-switch--sm">
								   <label>
									<input type="checkbox" {{$language->rtl === 1 ? "checked" : "" }} name="rtl" value="1">
									<span></span>
									</label>
									</span>
								</div>
