   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/language/create" method="post">
               @csrf
               <div class="kt-portlet__body">
                  <div class="form-group">
                     <label>Language Name</label>
                     <input class="form-control @error('language_name') is-invalid @enderror" value="{{ old('language_name') }}" type="text" id="language_name" name="language_name">
                     @error('language_name')
                  ...
                  <div class="form-group row">
							<label class="col-1 col-form-label">RTL</label>
							<div class="col-11">
								<span class="kt-switch kt-switch--sm">
								   <label>
									<input type="checkbox" checked="checked" name="rtl" value="1">
									<span></span>
									</label>
									</span>
								</div>
               ...
               <div class="kt-portlet__foot kt-portlet__foot--solid">
                  <div class="kt-form__actions">
                     <div class="row">
                        <div class="col-12">
                           <button type="submit" class="btn btn-brand"><i class="fa fa-paper-plane"></i> Submit Language</button>
                        </div>
                     </div>
                  </div>
               </div>
