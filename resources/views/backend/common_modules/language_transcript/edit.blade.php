   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/language/transcript/update/{{$transcript->id}}" method="post">
               @csrf
               <div class="kt-portlet__body">
                  <div class="form-group">
                     <label>English Syntax</label>
                     <input class="form-control @error('english_syntax') is-invalid @enderror" value="{{ old('english_syntax', $transcript->english_syntax) }}" type="text" id="english_syntax" name="english_syntax">
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control @error('translation') is-invalid @enderror" value="{{ old('translation', $transcript->translation) }}" type="text" id="translation" name="translation">
                     @error('translation')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
