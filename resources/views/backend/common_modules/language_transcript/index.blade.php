            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
               <div class="kt-portlet__head-label">
                  ...
                  <h3 class="kt-portlet__head-title">
                     {{$language->language_name}} Transcripts
                  </h3>
               </div>
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/language/transcript/create/{{$language->id}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  <thead>
                     <tr>
                        <th title="Field #1">#</th>
                        <th title="Field #2">English Version</th>
                        <th title="Field #4">Translation</th>
                  ...
                  <tbody>
                     ...
                     @foreach($transcripts as $transcript)
                        <tr>
                            <td>{{$i++}}</td>
                            <td>{{$transcript->english_syntax != null ? $transcript->english_syntax : "NILL"}}</td>
                            <td>{{$transcript->translation}}</td>
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/language/transcript/edit/{{$transcript->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/language/transcript', ['id' => $transcript->id]) }}" style="display: inline;" method="post">
