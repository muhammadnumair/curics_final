            ...
            <form class="kt-form kt-form--label-right" action="/account/expense/update/{{$expense->id}}" method="post">
               ...
               <div class="kt-portlet__body">
                  <div class="form-group">
                     ...
                     <input class="form-control @error('description') is-invalid @enderror" value="{{ old('description', $expense->description) }}" type="text" id="description" name="description">
                     @error('description')
                  ...
                  <div class="form-group">
                     <label>Amount</label>
                     <input class="form-control @error('amount') is-invalid @enderror" value="{{ old('amount', $expense->amount) }}" type="number" id="amount" name="amount">
                     @error('amount')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control @error('category') is-invalid @enderror" value="{{ old('category', $expense->category) }}" type="text" id="category" name="category">
                     @error('amount')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
