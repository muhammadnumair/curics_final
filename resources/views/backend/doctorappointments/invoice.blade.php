            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
               <div class="kt-invoice-2">
                  <div class="kt-invoice__head">
                     <div class="kt-invoice__container">
                        <div class="kt-invoice__brand">
                           <div>
                              <p class="kt-invoice__title" style="font-size: 1.3rem; margin-bottom: 0px;">{{$invoice->appointment->doctor->name}}</p>
                              <p style="font-size: 1rem; margin-bottom: 0px;" class="kt-invoice__desc">
                                 @foreach($invoice->appointment->doctor->qualification as $q)
                                 {{$q->degree}},
                                 @endforeach
                              </p>
                              <p style="margin-bottom: 0px" class="kt-invoice__desc"><b>{{$invoice->appointment->doctor->experience_years != null ? $invoice->appointment->doctor->experience_years : "0"}} Years Experience</b></p>
                              <p style="margin-bottom: 0px" class="kt-invoice__desc"><b>{{count($invoice->appointment->doctor->reviews)}} Positive Reviews</b></p>
                           </div>
                           <div href="#" class="kt-invoice__logo">
                              ...
                              <span>{{$invoice->appointment->clinic->address}}</span>
                              </span>
                           </div>
                        </div>
                        <div class="kt-invoice__items">
                           <div class="kt-invoice__item">
                              ...
                              <span class="kt-invoice__text">{{$invoice->appointment->patient_name}}</span>
                           </div>
                           <div class="kt-invoice__item">
                              <span class="kt-invoice__subtitle"><b>Date</b></span>
                              <span class="kt-invoice__text">{{date('d M Y', strtotime($invoice->appointment->created_at))}} {{date('h:i a', strtotime($invoice->appointment->time_slot))}}</span>
                           </div>
                           <div class="kt-invoice__item">
                              <span class="kt-invoice__subtitle"><b>Appointment No.</b></span>
                              <span class="kt-invoice__text">#{{$invoice->appointment->id}}</span>
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 <tr class="d-flex justify-content-end">
                                    <td class="kt-font-danger kt-font-xl kt-font-boldest"><span>Rs.</span> {{$invoice->appointment->payable_amount}}</td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
                  ...
                  <div class="kt-invoice__actions">
                     <div class="kt-invoice__container">
                        <a href="/account/prescription/create/{{$invoice->appointment->id}}" class="btn btn-label-success btn-bold">Generate Prescription</a>
