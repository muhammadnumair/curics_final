         ...
         <div class="kt-portlet kt-portlet--mobile">
               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/appointment/create" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
               <div class="kt-section__content kt-section__content--solid" style="padding: 1.5rem; border-left: 4px solid #e2e5ec; background-color: #f7f8fa; margin-bottom: 20px;">
						<a href="/account/appointments?filter=new"><span class="btn btn-primary">New Appointments</span></a>&nbsp;
						<a href="/account/appointments?filter=previous"><span class="btn btn-danger">Previous Appointments</span></a>&nbsp;
                  <a href="/account/appointments?filter=all"><span class="btn btn-success">All Appointments</span></a>&nbsp;
					</div>
                     ...
                     <tr>
                        ...
                        <td>
                           <span style="display: inline;">
                              ...
                              <button type="button" class="btn btn-bold btn-label-brand btn-sm" data-toggle="modal" data-target="#kt_modal_6" data-id="{{$q->id}}">Settings</button>
                              @endif
