               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/admin/module/create" class="btn btn-brand btn-elevate btn-icon-sm">
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  ...
                  <tbody>
                     ...
                     @foreach($modules as $q)
                        <tr>
                            <td>{{$i++}}</td>
                            <td>{{$q->name != null ? $q->name : "NILL"}}</td>
                            <td>
                                <span style="display: inline;">
                                    <a href="/admin/module/edit/{{$q->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/admin/module', ['id' => $q->id]) }}" style="display: inline;" method="post">
