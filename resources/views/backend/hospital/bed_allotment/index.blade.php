         ...
         <div class="kt-portlet kt-portlet--mobile">
               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/bedAllotment/create" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  <thead>
                     <tr>
                        <th title="Field #1">Bed Number</th>
                        <th title="Field #2">Patient Name</th>
                        <th title="Field #2">Allocated Time</th>
                        <th title="Field #2">Discharge Time</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{$allotment->bed->category->name}}-{{$allotment->bed->bed_number}}</td>
                        <td>{{$allotment->patient->name}}</td>
                        <td>{{$allotment->allocated_time}}</td>
                        <td>{{$allotment->discharge_time}}</td>
                        <td>
                           <span style="display: inline;">
                              <a href="/account/bedAllotment/edit/{{$allotment->id}}" class="btn btn-bold btn-label-success btn-sm">Edit</a>
                              <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/bedAllotment', ['id' => $allotment->id]) }}" style="display: inline;" method="post">
