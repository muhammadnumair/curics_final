               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/report/create" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/report/edit/{{$report->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/report', ['id' => $report->id]) }}" style="display: inline;" method="post">
