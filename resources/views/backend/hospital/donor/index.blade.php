               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/donor/create" class="btn btn-brand btn-elevate btn-icon-sm">
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  <thead>
                     <tr>
                        ...
                        <th title="Field #3">Blood Group</th>
                        <th title="Field #4">Age</th>
                        <th title="Field #4">Sex</th>
                        <th title="Field #4">Last Donation Date</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/donor/edit/{{$donor->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/donor', ['id' => $donor->id]) }}" style="display: inline;" method="post">
