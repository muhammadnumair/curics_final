   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/donor/create" method="post">
               @csrf
                <div class="kt-portlet__body">
                  ...
                  <div class="form-group">
                     <label>Age</label>
                     <input class="form-control @error('age') is-invalid @enderror" value="{{ old('age') }}" type="text" name="age">
                     @error('age')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="kt_datepicker_1" readonly placeholder="Select Last Donation Date" name="last_donation_date"/>
                  ...
                  <div class="form-group">
                     <label>Sex</label>
                     <input class="form-control @error('sex') is-invalid @enderror" value="{{ old('sex') }}" type="text" name="sex">
                     @error('sex')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
