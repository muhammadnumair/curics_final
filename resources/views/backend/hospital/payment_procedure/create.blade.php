   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/paymentProcedure/create" method="post">
               @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control @error('comission_rate') is-invalid @enderror" value="{{ old('comission_rate') }}" type="text" name="comission_rate">
