   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form" action="/account/hospital/appointment/create" method="post">
               @csrf
               <div class="kt-portlet__body">
                  <div class="form-group row">
							<label class="col-3 col-form-label">Company Institute Appointment</label>
							<div class="col-9">
								<span class="kt-switch kt-switch--sm">
								   <label>
									<input type="checkbox" name="company_ref" value="1" id="company_ref">
									<span></span>
									</label>
									</span>
								</div>
                  ...
                  <div class="form-group" id="companies">
                        ...
                        <select class="form-control m-select2" id="kt_select2_4" name="company_id" style="width: 100%;">
                  ...
                  <div class="form-group" id="emp_pos">
                        <label>Employee/Member Position</label><br>
                        <select class="form-control m-select2" id="kt_select2_100" name="employee_position" style="width: 100%;">
                           <option value="student">Student</option>
                           <option value="student">Professor</option>
                           <option value="student">Servent</option>
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control m-select2" id="kt_select2_2" name="doctor_id" style="width: 100%;">
                           ...
                           @if(isset($s_doctor))
                           <option value="{{$doctor->doctor->id}}" {{$s_doctor->id === $doctor->doctor->id ? 'selected' : ''}}>{{$doctor->doctor->name}}</option>
                           @else
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="kt_datepicker_1" readonly placeholder="Select Appointment Date" name="appointment_date"/>
                  </div>
                  <div class="row">
                     <div class="d-flex">
                        <div class="d-flex ml-2">
                           <div style="background: #2ECC71;width: 20px;height: 20px;border: 2px solid #E5E7E9;"></div>
                           <p class="ml-2">FREE</p>
                        </div>
                        <div class="d-flex ml-5">
                           <div style="background: #c21b15;width: 20px;height: 20px;border: 2px solid #E5E7E9;"></div>
                           <p class="ml-2">OCCOPIED</p>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="appointments_listing">
                        <div class="button-wrap time_slots">
                        </div>
                     </div>
                  </div>
               ...
               <div class="kt-portlet__foot kt-portlet__foot--solid">
                  <div class="kt-form__actions">
                     <div class="row">
                        <div class="col-12">
                           <button type="submit" class="btn btn-brand"><i class="fa fa-paper-plane"></i> Submit Appointment</button>
                        </div>
                     </div>
                  </div>
               </div>
