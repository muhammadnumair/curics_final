                  ...
                  <div class="kt-invoice__head">
                     <div class="kt-invoice__container">
                        <div class="kt-invoice__brand">
                           <div>
                              <p class="kt-invoice__title" style="font-size: 1.3rem; margin-bottom: 0px;">{{$appointment->doctor != null ? $appointment->doctor->name : 'Doctor Data Deleted'}}</p>
                              <p style="font-size: 1rem; margin-bottom: 0px;" class="kt-invoice__desc">
                                 @if($appointment->doctor != null && $appointment->doctor->qualification != null)
                                 @foreach($appointment->doctor->qualification as $q)
                                 {{$q->degree}},
                                 @endforeach
                                 @endif
                              </p>
                              <p style="margin-bottom: 0px" class="kt-invoice__desc"><b>{{$appointment->doctor != null ? $appointment->doctor->experience_years : "0"}} Years Experience</b></p>
                              <p style="margin-bottom: 0px" class="kt-invoice__desc"><b>{{$appointment->doctor->reviews != null ? count($appointment->doctor->reviews : '0')}} Positive Reviews</b></p>
                           </div>
                           <div href="#" class="kt-invoice__logo">
                              ...
                              <span>{{$appointment->clinic->clinic != null ? $appointment->clinic->clinic->address : ''}}</span>
                              </span>
                           </div>
                        </div>
