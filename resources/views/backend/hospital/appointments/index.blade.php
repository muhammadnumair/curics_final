      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
         <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
               <div class="kt-portlet__head-label">
                  ...
                  <h3 class="kt-portlet__head-title">
                     {{$s_doctor != null ? $s_doctor->name : "All"}} Appointments
                  </h3>
               </div>
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/hospital/appointment/create/{{$s_doctor != null ? $s_doctor->id : ''}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
               <div class="kt-section__content kt-section__content--solid" style="padding: 1.5rem; border-left: 4px solid #e2e5ec; background-color: #f7f8fa; margin-bottom: 20px;">
						<a href="/account/hospital/appointments?filter=new"><span class="btn btn-primary">New Appointments</span></a>&nbsp;
						<a href="/account/hospital/appointments?filter=previous"><span class="btn btn-danger">Previous Appointments</span></a>&nbsp;
                  <a href="/account/hospital/appointments?filter=all"><span class="btn btn-success">All Appointments</span></a>&nbsp;
					</div>
                     ...
                     <tr>
                        ...
                        <td>
                           <span style="display: inline;">
                              <a href="/account/appointment/invoice/{{$q->invoice != null ? $q->invoice->id : '#'}}" class="btn btn-bold btn-label-warning btn-sm">Invoice</a>
                              ...
                              <a href="/account/appointment/settings/{{$q->id}}" class="btn btn-bold btn-label-success btn-sm">Settings</a>
                              @endif
                              <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/hospital/appointment', ['id' => $q->id]) }}" style="display: inline;" method="post">
