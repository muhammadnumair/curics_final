                     ...
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{sprintf("%02d", $doctors_count)}}</a>
                           </h3>
               ...
               <div class="kt-portlet kt-iconbox kt-iconbox--wave">
                  <div class="kt-portlet__body">
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{sprintf("%02d", $patients_count)}}</a>
                           </h3>
                           <div class="kt-iconbox__content">
                              Patients
                           </div>
               ...
               <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                  <div class="kt-portlet__body">
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{sprintf("%02d", $appointments_count)}}</a>
                           </h3>
                           <div class="kt-iconbox__content">
                              Appointments
                           </div>
               ...
               <div class="kt-portlet kt-iconbox kt-iconbox--animate">
                  <div class="kt-portlet__body">
                     <div class="kt-iconbox__body">
                        ...
                        <div class="kt-iconbox__desc">
                           <h3 class="kt-iconbox__title">
                              <a class="kt-link" href="#">{{sprintf("%02d", $departments_count)}}</a>
                           </h3>
                           <div class="kt-iconbox__content">
                              Departments
                           </div>
