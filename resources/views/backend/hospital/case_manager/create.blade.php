   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form" action="/account/caseManager/create" method="post">
               @csrf
               <div class="kt-portlet__body">
               <div class="form-group">
                     <label>Title</label>
                     <input   type="text" class=" form-control" placeholder="Enter Case Title" name="title" value="{{old('title')}}">
                     @error('title')
                  ...
                  <div class="form-group">
                     <label>Date</label>
                     <input type="text" class="form-control" id="kt_datepicker_1" readonly placeholder="Select Case Date" value="{{old('date')}}" name="date"/>
                  </div>
                  
                  <div class="form-group ">
                     <label>Patient Phone Number</label>
                     <input  type="text" class=" form-control" placeholder="Enter Patient's Phone Number" id="patient_number" name="patient_number" value="{{old('patient_number')}}">
                  </div>
               ...
               <div class="form-group">
                  <label>Case</label>
                  <textarea id="report_content" class="form-control @error('case_description') is-invalid @enderror" name="case_description">{{ old('case_description') }}</textarea>
