   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/medicineCategory/update/{{$medicine_category->id}}" method="post">
               @csrf
                <div class="kt-portlet__body">
                <div class="form-group">
                     <label>Name</label>
                     <input class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $medicine_category->name) }}" type="text" name="name">
                     @error('name')
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control @error('status') is-invalid @enderror" value="{{ old('description', $medicine_category->description) }}" type="text" name="description">
                     @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
