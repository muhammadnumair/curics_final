               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/medicineCategory/create" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/medicineCategory/edit/{{$e_cat->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/medicineCategory', ['id' => $e_cat->id]) }}" style="display: inline;" method="post">
