               ...
               <div class="kt-portlet__head-toolbar">
                  <div class="kt-portlet__head-wrapper">
                     <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="/account/lab/report/create" class="btn btn-brand btn-elevate btn-icon-sm">
               ...
               <table id="table_id" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                  ...
                  <tbody>
                     ...
                     @foreach($reports as $report)
                        <tr>
                            <td>{{$i++}}</td>
                            <td>{{$report->patient != null ? $report->patient->name : "Patient Record Deleted"}}</td>
                            <td>{{$report->date}}</td>
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/lab/report/edit/{{$report->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <a href="/account/lab/report/invoice/{{$report->id}}" class="btn btn-warning btn-sm">Report</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/lab/report', ['id' => $report->id]) }}" style="display: inline;" method="post">
