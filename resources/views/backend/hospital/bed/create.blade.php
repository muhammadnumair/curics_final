   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form kt-form--label-right" action="/account/bed/create" method="post">
               @csrf
                ...
                <div class="form-group">
                     ...
                     <input class="form-control @error('bed_number') is-invalid @enderror" value="{{ old('bed_number') }}" type="text" name="bed_number">
                     @error('bed_number')
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control @error('status') is-invalid @enderror" value="{{ old('description') }}" type="text" name="description">
                     @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
