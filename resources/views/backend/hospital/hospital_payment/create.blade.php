                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
                  ...
                  <i class="kt-font-brand fa fa-star"></i>
                     ...
                     Add New Payment
                            ...
                            <form class="kt-form" action="/account/finance/payment/create" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col col-5">
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="loading_data" style=" position: relative; ">
                                                <!-- Spinner  -->
                                                <div class="loadingio-spinner-bars-whv1n2lzl1">
                                                    <div class="ldio-284ix4wfeaei">
                                                        <div></div>
                                                        <div></div>
                                                        <div></div>
                                                        <div></div>
                                    ...
                                    <div class="col col-4">
                                       ...
                                       <div class="form-group mr-5">
                                          ...
                                          <input type="text" class="form-control" id="deposited_amount" name="deposited_amount" value="0">
                                       </div>
                                    </div>
                                </div>
            ...
            <script>
                ...
                function updateCart() {
                    ...
                    for (i = 0; i < items.length; i++) {
                        content += "<tr><td>" + items[i].name + "-" + items[i].price + "</td><td>" + "<input type='number' style='width: 50px;' data-id='" + i + "' value='" + items[i].quantity + "' onchange='updateQuantity(this)' min='0' name='quantity[]'>" + "</td></tr>";
                    }
                ...
                $('#callbacks').multiSelect({
                    afterSelect: function(values) {
                        $.ajax({
                            type: 'POST',
                            url: '/account/get_procedure_detail',
                            data: {
                                _token: '<?php echo csrf_token() ?>',
                                procedure_id: values
                            },
