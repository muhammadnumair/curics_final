            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
               <div class="kt-invoice-2">
                  <div class="kt-invoice__head">
                     <div class="kt-invoice__container">
                        <div class="kt-invoice__brand">
                           <div>
                              <p class="kt-invoice__title" style="font-size: 1.3rem; margin-bottom: 0px;">{{$sale->clinic->name}}</p>
                              <span>{{$sale->clinic->address}}</span>
                           </div>
                              ...
                              <table class="table table-bordered table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$item->quantity}}</td>
                                       <td>{{$item->medicine->sale_price }}</td>
                                    </tr>
                                    @endforeach
                                 </tbody>
                              </table>
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 <tr class="d-flex justify-content-end">
                                    <td class="kt-font-danger kt-font-xl kt-font-boldest"><span>Rs.</span> {{$sale->gross_total}}</td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
                  ...
                  <div class="kt-invoice__actions">
                     <div class="kt-invoice__container">
                        <a href="/account/finance/sale/create" class="btn btn-label-success btn-bold">Make New sale</a>
