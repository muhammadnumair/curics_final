   ...
   <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor mt-5">
      ...
      <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="kt_content">
         <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-form" action="/account/lab/report/update/{{$report->id}}" method="post">
               @csrf
               ...
               <div class="form-group">
                  <label>Report</label>
                  <textarea id="report_content" class="form-control @error('report') is-invalid @enderror" name="report">{{ old('report', $report->report) }}</textarea>
                  @error('report')
