                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display: inline;">
                                    <a href="/account/expense/edit/{{$expense->id}}" class="btn btn-success btn-sm">Edit</a>
                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{ url('/account/expense', ['id' => $expense->id]) }}" style="display: inline;" method="post">
